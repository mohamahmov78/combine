...
public class BattleCryRandomMoveT extends BattleCry {
    private int[] randomCardCount;
    private String[] tribes;
    public BattleCryRandomMoveT (String[] tribes, String name, String details, int[] randomCardCount)
    {
    ...
    void doBattleCry (LinkedList<MonsterCard> beginningFriendly, LinkedList<MonsterCard> beginningEnemy, LinkedList<MonsterCard> destinationFriendly, LinkedList<MonsterCard> destinationEnemy)
    {
