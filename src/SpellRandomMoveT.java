...
public class SpellRandomMoveT extends Spell {
    private int[] randomCardCount;
    private String[] tribes;
    public SpellRandomMoveT (String[] tribes, String name, String details, int[] randomCardCount)
    {
    ...
    void doSpell (LinkedList<MonsterCard> beginningFriendly, LinkedList<MonsterCard> beginningEnemy, LinkedList<MonsterCard> destinationFriendly, LinkedList<MonsterCard> destinationEnemy)
    {
