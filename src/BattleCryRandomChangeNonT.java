...
public class BattleCryRandomChangeNonT extends BattleCry{
    private int[] randomCardCount;
    private int[] friendlyChanges, enemyChanges;
    BattleCryRandomChangeNonT (int[] friendlyChanges, int[] enemyChanges, int[] randomCardCount, String battleCryDetails, String battleCryName)
    {
    ...
    void doBattleCry (MonsterField friendlyMonsterField, MonsterField enemyMonsterField)
    {
