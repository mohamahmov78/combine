...
public class BattleCryRandomMoveNonT extends BattleCry {
    private int randomCardCount[];
    boolean destinationIsGraveyardFriendly, destinationIsGraveyardEnemy;
    public BattleCryRandomMoveNonT (String battleCryName, String battleCryDetails, int randomCardCount[], boolean destinationIsGraveyardFriendly, boolean destinationIsGraveyardEnemy)
    {
    ...
    void doBattleCry (LinkedList<Card> beginningFriendly, LinkedList<Card> destinationFriendly, LinkedList<Card> beginningEnemy, LinkedList<Card> destinationEnemy)
    {
