...
public class BattleCryRandomChangeT extends BattleCry {
    private int[] randomCardCount;
    private int[] friendlyChanges, enemyChanges;
    private String tribes[];
    BattleCryRandomChangeT (int[] randomCardCount, int[] friendlyChanges, String[] tribes, int [] enemyChanges, String name, String details)
    {
    ...
    void doBattleCry (MonsterField enemyMonsterField, MonsterField friendlyMonsterField)
    {
